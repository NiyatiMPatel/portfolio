...
function ProjectsAll() {
  const projectDataAll = [
    ...
    },
    {
      ...
      classTitle: "project-item-b",
      title: "React Meals",
      desc: "Application structured with a focus on modularity and reusability, designed to streamline the process of online food ordering. Built using the robust and dynamic framework to offers a user-friendly interface and efficient functionality.",
